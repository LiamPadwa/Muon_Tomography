...
class Logger:
    ...
    def __init__(self, name: str, log_level=logging.INFO, log_path: str = "D:\Above_the_spring_filtered\logs\log_run.log", console_output: bool = True):
        self.name = name
...
if __name__ == "__main__":
    ...
    sent_start = send_command_to_server(client, start_run_command,timeout_response=10)
    if sent_start is True:
        ...
        sent_stop = send_command_to_server(client_stop, stop_run_command, timeout_response=10)
