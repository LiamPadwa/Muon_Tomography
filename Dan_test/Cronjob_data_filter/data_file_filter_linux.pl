...
#
# Usage:
#   perl inOut_v2_windows.pl inputFile outFilename
...
# Check if input file has .data extension
if ($fileIn !~ /\.data$/) {
    die "Error: Input file must have .data extension. Received: $fileIn\n";
}

# Open output file without Windows line ending conversion
open RTOUT, "> $outputFile" or die("Could not open output file!");

# Open the input data file and handle any potential errors
open(RT, $fileIn) or die "Could not open file $fileIn: $!";
